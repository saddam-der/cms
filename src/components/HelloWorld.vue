...
<style scoped>
/* @import '../assets/libs/@fullcalendar/core/main.min.css';
        @import '../assets/libs/@fullcalendar/daygrid/main.min.css';
        @import '../assets/libs/@fullcalendar/bootstrap/main.min.css';
        @import '../assets/libs/@fullcalendar/timegrid/main.min.css';
        @import '../assets/libs/@fullcalendar/list/main.min.css'; */
</style>
